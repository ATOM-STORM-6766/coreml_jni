...
public class CoreMLTest {
    ...
    public void testBasicJNI() {
        ...
        String modelPath = Paths.get(System.getProperty("user.dir"), "src", "test", "resources", "coral_v1.mlmodel")
                .toString();
        ...
        // Test detect
        String imagePath = Paths.get(System.getProperty("user.dir"), "src", "test", "resources", "empty.png")
                .toString();
